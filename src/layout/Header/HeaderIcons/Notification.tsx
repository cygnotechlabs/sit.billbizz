    ...
    <>
      ...
      <Drawer onClose={toggleDrawer} open={isDrawerOpen} position="right">
        ...
        <div className="p-4">
          <div className="space-y-4">
            {[
              {
                imgSrc:
                  "https://s3-alpha-sig.figma.com/img/2fd1/0ec0/20560c9d065063d514849db74893d9aa?Expires=1721001600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=fX0-Tk8qFUIFhPfaq9rbvEHGTwvK8fND-QMiobpOgY5EdkyQIc1Uuero5P5lPMV-OrRDwoSI6QzfFqvnJ8nef9GXbfDiBeUXaHAiouwKYFi~dFuUOuVM5NgJIMbF8JaQZy3EGU42kOMb781Dq2G1wL1RG~LJnypJVtGnhlcJ5PNAUVUbEWqPp81aubSd9Nv3hNvHtIjWp82~w23yggTSDXKnL582hluACBsoTU61m~BgrZdp4Xd2e0rfTlurzwasjwY5gBGOcUMoad8ziOu0G6-YtcYnf8Ukvbrp6hjhrZJggA-HvGnxtVREilyFvak9gz~jvSfX27w42agHQZmckg__",
                title: "Out of Stock",
                count:
                  "Item [Product Name] is now out of stock. Please restock as soon as possible.",
                time: "Friday 10:04am",
                date: "Jun 20, 2024",
              },
              {
                imgSrc:
                  "https://s3-alpha-sig.figma.com/img/0404/8874/bcd210f64cacfe712297b84b5ccf2167?Expires=1721001600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=mBdMeWe1phM64aftLfzxKOYCg2KGgQjPoKJTI1smGDxpMcTLhWXPMonvASd1JhFtAWR9zoF6GqUrTemShPT6RGMfnPMvHnp6ODxOj8--MoIJcyRe0Pn17Ijs9m9urHqnyRiK2NI~QxLHsa~KMW2bjZvI4pbl4uitBLIguGTwcOPW7Z3HzL030~SsS1HDk1k6sbW~avAF7qa0sYSEaQ-HvlKwGNEswRP~ynxId2JgBxGhfs2qmiMAhIEbF-8lb9OFfvalfn8OafYUHY7~enUEXNH6wl1d4I5wx5H3~qEmvOFCBXbliNt9zIX2-myD2H48D~LrtL~5MB29NR0SaVZD7w__",
              ...
              <div
                key={index}
                className="p-4 flex border border-slate-200 rounded-md shadow-sm"
              >
                <div className="mr-4">
                  <img
        ...
        <div className="flex justify-end me-3 mt-5">
          <Button size="sm">
            <p className="text-[11px]">View all notifications</p>
          </Button>
        </div>
      </Drawer>
    </>
