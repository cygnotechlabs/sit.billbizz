pipeline {
    ...
    environment {
        ...
        ECR_REPOSITORY = 'billbizz/suppliers'
        IMAGE_NAME = 'billbizz-suppliers'
        AWS_CREDENTIALS_ID = '2157424a-b8a7-45c0-90c2-bc0d407f6cea'
        AWS_ACCOUNT_ID = '654654462146' // Add your AWS account ID here
        SONARQUBE_PROJECT_KEY = 'billbizz-suppliers'
        SONARQUBE_SCANNER_CREDENTIALS_ID = '7a78b038-fe36-41c0-aef3-8105ede4782e' // Jenkins credentials ID for SonarQube token
        ECS_CLUSTER_NAME = 'dev-billbizz' // Replace with your ECS cluster name
        ECS_SERVICE_NAME = 'billbizz-suppliers' // Replace with your ECS service name
        ECS_TASK_DEFINITION_NAME = 'billbizz-suppliers' // Replace with your ECS task definition name
    }
